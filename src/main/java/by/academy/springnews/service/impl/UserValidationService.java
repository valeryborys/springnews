...
public class UserValidationService implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        errors.rejectValue("username", "Username length should be more than 4, but less than 32 characters");
        }
        ...
        if (user.getPassword().length() < 8  || user.getPassword().length() > 32){
            errors.rejectValue("password", "Password length should be more than 8, but less than 32 characters");
        }
